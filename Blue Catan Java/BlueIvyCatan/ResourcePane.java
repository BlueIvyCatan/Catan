...
//        this.setPrefSize(150,150);
        ...
        Image d = new Image("BlueIvyCatan/deck.png",160,160,true,true);
        ...
        Image defaultDie = new Image("BlueIvyCatan/defaultdieface.png", 80,80,true,false);
        ...
        Image b = new Image("BlueIvyCatan/brick.jpg",80, 80, true, false);
        Image o = new Image("BlueIvyCatan/ore.jpg",80,80,true, false);
        Image wh = new Image("BlueIvyCatan/wheat.jpg", 80,80,true,false);
        Image s = new Image("BlueIvyCatan/sheep.jpg", 80,80,true,false);
        Image wo = new Image("BlueIvyCatan/wood.jpg", 80, 80, true, false);
        ...
        Image vp = new Image("BlueIvyCatan/victorypointcard.jpg",80,80,false,true);
        Image kn = new Image("BlueIvyCatan/knight.jpg",80,80,false,true);
        Image rb = new Image("BlueIvyCatan/roadbuilding.jpg", 80,80,false,true);
        Image mo = new Image("BlueIvyCatan/monopoly.jpg",80,80,false,true);
        Image yop = new Image("BlueIvyCatan/yearofplenty.jpg",80,80,false,true);
